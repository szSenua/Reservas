...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['reservar_alternativo'])) {
    ...
    if (count($errores) == 0) {
        ...
        //Procesas la reserva
        $restaurante = $_SESSION['alternativo'];
...
<body>
    <form action="" method="POST">
        ...
        <input type="submit" name="reservar_alternativo" value="Reservar">
    </form>
</body>
